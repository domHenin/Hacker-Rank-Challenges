...
//   Task
//   Given
// names and phone numbers, assemble a phone book that maps friends' names to their respective phone numbers.
...
//  >>Each of the subsequent lines describes an entry in the form of space-separated values on a single line. The
//  first value is a friend's name, and the second value is an
//  -digit phone number.
//  After the
